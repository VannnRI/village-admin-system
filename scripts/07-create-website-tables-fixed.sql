...
ON CONFLICT (village_id) DO UPDATE SET
    ...
    village_tagline = EXCLUDED.village_tagline,
    village_description = EXCLUDED.village_description,
    village_address = EXCLUDED.village_address,
    village_phone = EXCLUDED.village_phone,
    village_email = EXCLUDED.village_email,
...
-- Insert birth certificate service
INSERT INTO village_services (village_id, service_name, description, requirements, procedure, duration, is_active)
SELECT 
    v.id,
...
-- Insert business permit service
INSERT INTO village_services (village_id, service_name, description, requirements, procedure, duration, is_active)
SELECT 
    v.id,
...
-- Insert domicile certificate service
INSERT INTO village_services (village_id, service_name, description, requirements, procedure, duration, is_active)
SELECT 
    v.id,
...
CREATE TRIGGER update_village_news_updated_at BEFORE UPDATE ON village_news FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
